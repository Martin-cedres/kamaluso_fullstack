...
export default function ProductDetailPage({ product, relatedProducts }: Props) {
  ...
  return (
    <>
      <SeoMeta title={pageTitle} description={pageDescription} image={pageImage} url={canonicalUrl} type="product" />
      <Navbar />
        ...
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-12">
          ...
          <div className="flex-1 flex flex-col justify-between">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-6">
              <button onClick={handleAddToCart} className="bg-pink-500 text-white px-6 py-3 rounded-2xl font-semibold shadow-lg hover:bg-pink-600 transition">Agregar al carrito</button>
              <button onClick={() => router.back()} className="px-6 py-3 rounded-2xl border border-pink-500 text-pink-500 font-semibold text-center hover:bg-pink-50 transition">Ir atrás</button>
            </div>
          </div>
        </div>
