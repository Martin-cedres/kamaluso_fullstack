          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                value={form.nombre}
                onChange={(e) =>
                  setForm((f: any) => ({ ...f, nombre: e.target.value }))
                }
                required
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                onChange={(e) =>
                  setForm((f: any) => ({ ...f, destacado: e.target.checked }))
                }
                className="h-4 w-4"
              />
            ...
            <div>
              ...
              <textarea
                ...
                onChange={(e) =>
                  setForm((f: any) => ({ ...f, descripcion: e.target.value }))
                }
                className="w-full rounded-xl border px-3 py-2.5"
                rows={4}
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div>
                ...
                <input
                  ...
                  value={form.seoTitle}
                  onChange={(e) =>
                    setForm((f: any) => ({ ...f, seoTitle: e.target.value }))
                  }
                  className="w-full rounded-xl border px-3 py-2.5"
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Keywords SEO (coma separadas)
                </label>
                <input
                  type="text"
                  value={form.seoKeywords}
                  onChange={(e) =>
                    setForm((f: any) => ({ ...f, seoKeywords: e.target.value }))
                  }
                  className="w-full rounded-xl border px-3 py-2.5"
                />
              </div>
            ...
            <div>
              ...
              <input
                ...
                value={form.alt}
                onChange={(e) =>
                  setForm((f: any) => ({ ...f, alt: e.target.value }))
                }
                className="w-full rounded-xl border px-3 py-2.5"
              />
            </div>
            ...
            <div className="flex gap-3 pt-4 border-t">
              <button
                type="submit"
                disabled={loading}
                className="bg-fucsia text-white px-6 py-2 rounded-2xl shadow"
              >
              ...
              <button
                type="button"
                onClick={() => resetForm()}
                className="bg-white border px-4 py-2 rounded-2xl"
              >
                Cancelar
              </button>
              {loading && (
                <div className="ml-4 text-sm text-gray-600 self-center">
                  {progress > 0 ? `Subiendo... ${progress}%` : 'Procesando...'}
                </div>
              )}
            </div>
          </form>
