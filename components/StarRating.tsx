    ...
    <div className="flex items-center">
      ...
      {halfStar && (
        <svg className="w-5 h-5 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
          <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.286 3.957a1 1 0 00.95.69h4.162c.969 0 1.371 1.24.588 1.81l-3.368 2.448a1 1 0 00-.364 1.118l1.287 3.957c.3.921-.755 1.688-1.54 1.118L10 15.347V2.221l-1.287 3.957a1 1 0 00-.364 1.118l3.368 2.448c.784.57 1.838-.197 1.54-1.118L9.049 2.927z" />
        </svg>
      )}
