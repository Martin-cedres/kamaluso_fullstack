...
const seoStrategySchema = new mongoose_1.Schema({
...
const SeoStrategy = mongoose_1.default.models.SeoStrategy || mongoose_1.default.model('SeoStrategy', seoStrategySchema);
exports.default = SeoStrategy;
