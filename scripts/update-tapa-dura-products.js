...
async function updateTapaDuraProducts() {
  ...
  try {
    ...
    console.log('Buscando productos en la categoría "tapa-dura" para actualizar...');
    ...
    console.log(`Resumen: ${result.matchedCount} productos encontrados, ${result.modifiedCount} productos modificados.`);

    if (result.matchedCount === 0) {
      console.log('No se encontraron productos en la categoría "tapa-dura". Asegúrate de que la categoría esté escrita correctamente en la base de datos.');
    }
