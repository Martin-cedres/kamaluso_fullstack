...
const uri =
  'mongodb+srv://martinfernandocedres:mc00232481@kamaluso.t6jigkj.mongodb.net/kamaluso?retryWrites=true&w=majority' // <-- ¡CAMBIA ESTO!
...
async function run() {
  ...
  try {
    ...
    for (const product of allProducts) {
      ...
      const subCategoria = Array.isArray(product.subCategoria)
