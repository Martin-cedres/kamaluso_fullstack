...
const keyword_research_1 = require("./keyword-research");
/**
 ...
 */
async function analyzeCompetitors(productName, category) {
    try {
        ...
        for (const query of searchQueries) {
            const suggestions = await (0, keyword_research_1.getGoogleSuggestions)(query);
    ...
    `;
        const analysis = await (0, gemini_client_1.generateContentSmart)(prompt);
